...
<div class="legal-page">
    ...
    <div class="container" style="max-width: 900px; padding-top: 40px; margin-bottom: 0;">
        <h1 style="font-size: 2.2rem; font-weight: 800; color: #111827; margin-bottom: 6px;">Disclaimer</h1>
        <p style="font-size: 0.95rem; color: #64748b; font-weight: 600; margin-bottom: 0;">Penyangkalan & batasan tanggung jawab {{ config('app.name') }}</p>
    </div>
            ...
            <div style="background: white; padding: 0;">
                <div class="prose" style="color: #334155; line-height: 1.6;">
                    ...
                    <div style="margin-bottom: 35px;">
                        ...
                        <p style="font-size: 0.95rem;">Situs ini mungkin berisi tautan to situs web pihak ketiga. Kami tidak memiliki kendali atas isi dan ketersediaan situs-situs tersebut. Pencantuman tautan tidak selalu menyiratkan rekomendasi terhadap isi di dalamnya.</p>
                    </div>
