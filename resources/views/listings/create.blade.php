                ...
                <div class="form-group-horizontal">
                    ...
                    <div class="form-input-side">
                        ...
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 5px;">
                            ...
                            <small class="text-muted" id="description-char-count" style="font-weight: 600; font-size: 0.85rem; margin: 0;">0/{{ get_setting('huruf_deskripsi_iklan', 100) }}</small>
                        </div>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="form-input-side">
                        ...
                        <script>
                            document.addEventListener('DOMContentLoaded', function() {
                                ...
                                window.tagifyInstance.on('add', function(e) {
                                    if (window.tagifyInstance.value.length >= {{ get_setting('max_category', 3) }}) {
